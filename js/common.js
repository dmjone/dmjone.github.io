...
function header_nav() {
    ...
    var nav_subpath = '<a href="/' + nav_subfolder + '" data-toggle="tooltip" data-placement="top" title="' + nav_subfolder + '" data-original-title="' + nav_subfolder + '"><i class="bi bi-journals text-light"></i></a>';

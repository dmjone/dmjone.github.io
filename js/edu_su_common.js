...
function header_nav() {
    ...
    var nav_folder = secondary + url.pathname.split("/")[4];
    ...
    var nav_subpath = '<a href="/' + nav_subfolder + '/" data-toggle="tooltip" data-placement="top" title="' + nav_subfolder + '" data-original-title="' + nav_subfolder + '"><i class="bi bi-card-list text-light"></i></a>';
